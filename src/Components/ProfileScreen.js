...
// React-icons imports using correct modules
import { IoMoonOutline, IoSunnyOutline } from 'react-icons/io5';
import { MdLogout, MdPerson, MdEdit, MdEmail } from 'react-icons/md';
import { MdDeleteOutline as MdDeleteOutline, MdAccountCircle as MdAccountCircle } from 'react-icons/md';
...
// A reusable MenuItem component for the options menu
...
const ProfileScreen = () => {
  ...
  // Fetch profile details from the backend using the token stored in localStorage
  ...
  // Handle image editing via a file input (simulate an image picker)
    ...
    return (
      <div className={`min-h-screen ${isDarkMode ? 'bg-gray-900' : 'bg-white'} flex flex-col items-center pt-10`}>
        ...
        <div className="mt-6 w-full max-w-md space-y-3">
          ...
          />
          <MenuItem
            icon={<AiOutlineInfoCircle name="share-apple" size={22} color={isDarkMode ? '#fff' : '#4a4a4a'} />}
    ...
    <div className={`min-h-screen ${isDarkMode ? 'bg-gray-900' : 'bg-white'}`}>
      <div className="max-w-3xl mx-auto p-4">
        ...
        <div className="flex flex-col items-center mb-6">
          ...
          <p className="text-2xl font-medium text-gray-800">{account.name}</p>
        </div>
